...
class Veterinarios24H:
    ...
    def __init__(self):
        ...
        self.max_retries = 3
        self.json_filename = f"pa_veterinarios24h_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    ...
    def main(self):
        ...
        try:
            ...
            URL = "https://www.paginasamarillas.es/a/veterinario-24-horas/madrid/"
